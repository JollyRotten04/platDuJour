...
<!-- Header Component -->
<div class="h-fit w-full flex flex-col fixed z-100 bg-[#e3f0eb] top-0 left-0 pt-2 pl-2 pr-2 box-border">

    <!-- Main Container -->
    <div class="h-full flex justify-between items-center px-2 md:px-6 lg:px-12">

        <!-- Logo -->
        <img src="/logo/logo.svg" class="h-14 sm:h-14 md:h-16 lg:h-18 landscape:h-12 sm:landscape:h-14" alt="">
        ...
        <div class="flex gap-6 portrait:hidden portrait:md:flex portrait:lg:flex md:gap-10 lg:gap-14">
            ...
            <button onclick={() => {changeSelectedOptionStyling("Home")}} id="homeOption" class="text-sm md:text-lg lg:text-xl text-[#1E3D30] cursor-pointer select-none">Home</button>
            <button onclick={() => {changeSelectedOptionStyling("Recipes")}} id="recipesOption" class="text-sm md:text-lg lg:text-xl text-[#1E3D30] cursor-pointer select-none">Recipes</button>
            <button onclick={() => {changeSelectedOptionStyling("Diets")}} id="dietsOption" class="text-sm md:text-lg lg:text-xl text-[#1E3D30] cursor-pointer select-none">Diets</button>
            <button onclick={() => {changeSelectedOptionStyling("Articles")}} id="articlesOption" class="text-sm md:text-lg lg:text-xl text-[#1E3D30] cursor-pointer select-none">Articles</button>
            <button onclick={() => {changeSelectedOptionStyling("Login")}} id="loginOption" class="text-sm md:text-lg lg:text-xl text-[#1E3D30] cursor-pointer select-none">Login</button>
